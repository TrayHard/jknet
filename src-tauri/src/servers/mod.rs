...
mod tests {
    ...
    fn row(infostring: &str) -> ServerInfo {
        game_row(Game::JediAcademy, "203.0.113.136:29070", infostring)
    }
    ...
    fn reads_every_key_of_a_full_info_response() {
        ...
        assert_eq!(server.address, "203.0.113.136:29070");
    ...
    fn falls_back_when_keys_are_missing() {
        ...
        assert_eq!(server.hostname_clean, "203.0.113.136:29070");
    ...
    fn decorating_stars_the_addresses_the_player_saved() {
        ...
        let marks = starred(&["203.0.113.136:29070"]);
    ...
    fn decorating_hides_the_addresses_the_player_took_off_the_list() {
        ...
        let marks = Marks {
            favorites: ["203.0.113.136:29070".to_string()].into_iter().collect(),
            hidden: ["203.0.113.136:29070".to_string()].into_iter().collect(),
        };
    ...
    fn an_older_cache_row_gets_its_split_back() {
        ...
        let old = "{\"updatedAt\":\"2026-09-10T00:00:00Z\",\"servers\":[{\
            \"address\":\"203.0.113.136:29070\",\"hostnameRaw\":\"Blue\",\
    ...
    fn a_row_written_before_0_4_survives_the_field_that_was_dropped() {
        ...
        let old = "{\"updatedAt\":\"2026-09-10T00:00:00Z\",\"servers\":[{\
            \"game\":\"ja\",\"address\":\"203.0.113.136:29070\",\
