...
mod tests {
    ...
    fn row(infostring: &str) -> ServerInfo {
        ServerInfo::from_infostring(
            "203.0.113.136:29070".parse().unwrap(),
            infostring,
            42,
    ...
    fn decorating_applies_both_flags() {
        ...
        let trusted: HashSet<String> = ["203.0.113.136:29070".to_string()].into_iter().collect();
    ...
    fn reads_an_address_with_and_without_a_port() {
        assert_eq!(
            parse_address("203.0.113.136").unwrap().to_string(),
            "203.0.113.136:29070"
        );
        assert_eq!(
            parse_address("  203.0.113.136:29071 ").unwrap().to_string(),
            "203.0.113.136:29071"
        );
